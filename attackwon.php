...
You knock {$r['username']} on the floor a few times to make sure he is unconscious, then open his wallet, snatch \$$stole, and run home happily.";
...
print "<br />You earnt 2 respect for your gang!";
